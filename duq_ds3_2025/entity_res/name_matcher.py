...
from duq_ds3_2025.entity_res import db
from duq_ds3_2025.entity_res import name_classifier
...
class NameMatcher:
    ...
    def predict_matches(self):
        ...
        for block, result_df in self.blocks():
            ...
            print(result_df)
            # NOTE: Push only matches to bridge table


if __name__ == '__main__':
    pipeline = NameMatcher(db_path='data/example_patent_npi_db.sqlite')
    pipeline.train()
    # NOTE: Add save model
